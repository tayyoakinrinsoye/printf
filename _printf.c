 ...
 *loop_format - This is a lopping of the functions

 *@arg: va_list arg

 *@string: pointer from format

 *Description: This function make loop

 *Return: num of charactere
 ...
 * call_function_manager

 *@aux: character parameter

 *@arg: va_list arg

 *Description: This function call function

 *Return: num of characteres
